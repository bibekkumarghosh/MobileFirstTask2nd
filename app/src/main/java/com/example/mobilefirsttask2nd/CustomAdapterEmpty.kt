...
class CustomAdapterEmpty: RecyclerView.Adapter<CustomAdapterEmpty.ViewHolder>() {
...
//        holder.textView.text = titles_empty[position]
        holder.imageView.setImageResource(images[emptyList[position]])

        // sets the text to the textview from our itemHolder class
        holder.textView.text = titles[emptyList[position]]
